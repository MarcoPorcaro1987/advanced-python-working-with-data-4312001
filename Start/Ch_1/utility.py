...
print(sum(quake["properties"]["felt"]
      is not None and quake["properties"]["felt"] > 500 for quake in data["features"]))

# TODO: how many quakes had a magnitude of 6 or larger?
print(sum(quake["properties"]["mag"]
      is not None and quake["properties"]["mag"] >= 6  for quake in data["features"]))
